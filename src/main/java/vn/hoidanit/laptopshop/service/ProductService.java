...
public class ProductService {
    ...
    // //case1--------------------
    // public Page<Product> getAllProduct(Pageable page, double min) {
    // Page<Product> lstAllProduct =
    // this.productRepository.findAll(ProductSpecs.minPrice(min), page);
    // return lstAllProduct;
    // }

    // //case 2--------------------
    // public Page<Product> getAllProduct(Pageable page, double max) {
    // Page<Product> lstAllProduct =
    // this.productRepository.findAll(ProductSpecs.maxPrice(max), page);
    // return lstAllProduct;
    // }

    // //case3
    // public Page<Product> getAllProduct(Pageable page, String factory) {
    // Page<Product> lstAllProduct =
    // this.productRepository.findAll(ProductSpecs.matchFactory(factory), page);
    // return lstAllProduct;
    // }

    // //case4 tim theo nhieu loai may
    // public Page<Product> getAllProduct(Pageable page, List<String> factory) {
    // Page<Product> lstAllProduct =
    ...
    // // case5 tim trong khong gia
    // public Page<Product> getAllProduct(Pageable page, String price) {
