...
public class ItemController {
    ...
    public String handleAddProductFromViewDetail(
        ...
        long quantity_pr = 1;
        if (quantity != "") {
            quantity_pr = Long.parseLong(quantity);
        }

        this.productService.handleAddProductToCart(email, id, session, quantity_pr);
    ...
    public String getProductPage(Model model, ProductCriteriaDTO productCriteriaDTO,
        ...
        Page<Product> prs = this.productService.getAllProduct(pageable, productCriteriaDTO);
